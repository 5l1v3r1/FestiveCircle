function addMenu(){
    ...
    function createControll(NoOfRec) {
      ...
      for (i = 1; i <= NoOfRec; i++) {
        ...
        "<input onblur=\"menuTitleBlur(this)\" oninput=\"menuTitleInput(this)\" type=\"text\" id=\"menu_title_"+i+"\" placeholder=\"Title\" name=\"menu_title_"+i+"\" data-pass=\"1\">"+
        "<label class=\"\" id=\"menu_title_"+i+"_status\"></label><br>"+
  
        "<label class=\"menu-heading\">Menu Price</label><br>" +
        "<input onblur=\"menuPriceBlur(this)\" oninput=\"menuPriceInput(this)\" id=\"menu_price_"+i+"\" name=\"menu_price_"+i+"\" placeholder=\"Price\" name=\"menu_price_"+i+"\" data-pass=\"1\">"+
        "<label class=\"\" id=\"menu_price_"+i+"_status\"></label><br>"+
  
        "<label class='menu-heading'>Menu Description</label><br>" +
        "<textarea onblur=\"menuDescriptionBlur(this)\" oninput=\"menuDescriptionInput(this)\" id=\"menu_description_"+i+"\" name=\"menu_description_"+i+"\" style=\"width: 100%;\" placeholder='Description' data-pass=\"1\"></textarea>"+
